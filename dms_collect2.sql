...
WHERE s.state = 'виконана'
	and s."method" <> 'Е-Малятко'
--	and r.created::date > '2021-03-31' and r.created::date < CURRENT_DATE
	and r.created::date = '2021-08-03'
--	and r.created::date = '2021-05-15'
--	and r.created::date = '2021-05-22'
--	and r.created::date = '2021-06-04'
--	and r.created::date = '2021-06-05'
--	and r.created::date = '2021-06-09'
--	and r.created::date = '2021-06-11'
--	and r.created::date = '2021-06-12'
--	and r.created::date = '2021-06-18'
--	and r.created::date = '2021-06-19'
--	and r.created::date = '2021-06-23'
--	and r.created::date = '2021-06-25'
--	and r.created::date = '2021-06-26'
--	and r.created::date = '2021-07-02'
--	and r.created::date = '2021-07-03'
--	and r.created::date = '2021-07-09'
--	and r.created::date = '2021-07-10'
--	and r.created::date = '2021-07-14'
--	and r.created::date = '2021-07-15'
--	and r.created::date = '2021-06-24'
--  and r.citizen_id = '981a4303-7595-40df-8759-48ba07eb7f43'
--	and r.id = '7641603'
