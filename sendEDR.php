...
function callPersonInfoService($requestID, $sourceRequestID, $requestData, $requestDataSign, $status = '')
{
    ...
    try {
        $res = $soapclient->InfMsgResult($param0, $param1, $param2, $param3, $param4);
    ...
    error_log(
        date('Y-m-d H:i:s P') . " [" . $requestID . "][" . $sourceRequestID . "]" . " LastRequest=" . $soapclient->__getLastRequest() . "\n",
        3,
        "/home/.../sendDms_raw.log"
    );
    error_log(
        date('Y-m-d H:i:s P') . " [" . $requestID . "][" . $sourceRequestID . "]" . " LastResponse=" . $soapclient->__getLastResponse() . "\n\n",
        3,
        "/home/.../sendDms_raw.log"
    );
